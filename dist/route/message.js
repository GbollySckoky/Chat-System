 ...
 */
router.get('/messages/:roomId', messageController_1.getMessages);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/rooms', messageController_1.getRooms);
/**
 * @swagger
 * /api/v1/messages/rooms:
 *   post:
 ...
 *         description: Internal server error
 */
router.post('/rooms', messageController_1.createRoom);
/**
 * @swagger
 * /api/v1/messages/{roomId}:
 *   delete:
 ...
 *         description: Internal server error
 */
router.delete('/rooms/:roomId', messageController_1.deleteRoom);
/**
 * @swagger
